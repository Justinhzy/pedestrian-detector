...
__C.DEDUP_BOXES = 1. / 8.  ############################################ 0.125

# Pixel mean values (BGR order) as a (1, 1, 3) array
# We use the same pixel mean for all networks even though it's not exactly what
# they were trained with
__C.PIXEL_MEANS = np.array([[[103.939, 116.779, 123.68]]])  #[103.939, 116.779, 123.68]
...
__C.MAX_NUM_IGNORE_REGION = 30
# Anchor scales for RPN
__C.ANCHOR_SCALES = [2.0, 2.7, 3.64, 4.92, 6.64, 8.97, 12.11, 16.34, 22.06, 29.79, 40.21]  ##

# Anchor ratios for RPN
__C.ANCHOR_RATIOS = [2.44]  #######################################[2.44]
